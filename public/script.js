...
window.addEventListener("DOMContentLoaded",function(){
    ...
    var createScene = function(){
        ...
        // BABYLON.SceneLoader.ImportMesh("","","head2.obj",scene,
        // function(newMeshes){
        //     newMeshes.forEach(function(mesh){
        //         mesh.rotation = new BABYLON.Vector3(
        //             BABYLON.Tools.ToRadians(30),
        //             BABYLON.Tools.ToRadians(270),0
        //         )
        //         mesh.position = new BABYLON.Vector3(20,20,20);
        ...
        //     })
        // })
        // BABYLON.SceneLoader.ImportMesh("","","head3.obj",scene,
        // function(newMeshes){
        //     newMeshes.forEach(function(mesh){
        //         mesh.rotation = new BABYLON.Vector3(
        ...
        //             BABYLON.Tools.ToRadians(170),0
        //         )
        //         mesh.position = new BABYLON.Vector3(-10,10,-20);
        //         mesh.scaling = new BABYLON.Vector3(3,3,3);
        ...
        BABYLON.SceneLoader.ImportMesh("","","earth.babylon",scene,
        function(newMeshes){
            ...
            panel1.isPickable=true;
            panel2.isPickable=true;
            panel3.isPickable=true;


            panel1.actionManager = new BABYLON.ActionManager(scene);
            panel1.actionManager.registerAction(
            ...
            panel2.actionManager = new BABYLON.ActionManager(scene);
            panel2.actionManager.registerAction(
                new BABYLON.ExecuteCodeAction( { trigger: BABYLON.ActionManager.OnPickTrigger, parameter:" "}, 
                function(){
            ...
            panel3.actionManager = new BABYLON.ActionManager(scene);
            panel3.actionManager.registerAction(
                new BABYLON.ExecuteCodeAction( { trigger: BABYLON.ActionManager.OnPickTrigger, parameter:" "}, 
                function(){
